...
import "../cdlc/modelresults" as mres
...
for classname in classes:
    ...
    prmList.append(["RMSprop", 0.001, 0.5, 0.000001,1,300,10,1000,2,128,[128,128],2,0.01,test_per,train_per,"additive","minmax",classname])
    prmList.append(["RMSprop", 0.001, 0.5, 0.000001,1,300,10,1000,2,128,[128,128],2,0.01,test_per,train_per,"tanh","minmax",classname])
    ...
    for prm in prmList:
        ...
        classifier = Net(modelPrms).cuda()  # define the network
